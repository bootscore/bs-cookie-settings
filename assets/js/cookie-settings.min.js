        ...
        var _createCookieConsentHTML = function(never_accepted, conf_params){
            ...
            _createConsentModal = function(conf_params){
                ...
                var primary_btn_data = conf_params.languages[lang]['consent_modal']['primary_btn'],   // accept current selection
                    ...
                    settings_btn_data_01 = conf_params.languages[lang]['consent_modal']['settings_btn_01']; //Settings 1
                ...
                // Add banner footer button if not falsy
                if(settings_btn_data_01){
                  
                 
                  
                  /*
                if(consent_modal){
                    settings_btn_data_01.innerHTML = settings_btn_data_01;
                    return;
                }
*/

                    var consent_settings_btn_01 = _createNode('div');
                    consent_settings_btn_01.id = 'set-s-bn-1';
                    consent_settings_btn_01.className = "c-bn c_link small text-secondary";
                    consent_settings_btn_01[innerText] = conf_params.languages[lang]['consent_modal']['settings_btn_01']['text'];
                    //consent_settings_btn_01[innerHTML] = conf_params.languages[lang]['consent_modal']['settings_btn_01']['text'];

                  
                    //consent_settings_btn_01.setAttribute('data-bs-toggle', 'modal');
                    //consent_settings_btn_01.setAttribute('data-bs-target', '#bs-cookie-modal');
                }

                // Swap buttons
                var gui_options_data = conf_params['gui_options'];
                if(gui_options_data && gui_options_data['consent_modal'] && gui_options_data['consent_modal']['swap_buttons'] === true){
                  settings_btn_data_01 && consent_buttons.appendChild(consent_settings_btn_01);   
